...
final class DessertDisplayerTests: XCTestCase {
    ...
    func test_fetchImage() {
        let mealVC = MealVC()
        let testURL = "https://www.bbcgoodfood.com/recipes/1837/canadian-butter-tarts"
        mealVC.fetchImageTest( from: URL(string: testURL)!)
        print(mealVC.imageTestLogger)
        
        //        XCTAssertNotNil(mealVC.fetchImageTest(from: URL(string: testURL)!))
    }
}
